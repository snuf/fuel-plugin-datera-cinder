Test Plan for Datera Cinder Fuel Plugin
=======================================
...
+--------------------------------------------------+----------------------------------+----------------+---------------------+
| fuel-plugin-datera-cinder-1.0-1.0.0-1.noarch.rpm | b0e6042b46235c3acf9199acc7a19f53 | 7.0            | Kilo                |
+--------------------------------------------------+----------------------------------+----------------+---------------------+
| fuel-plugin-datera-cinder-1.0-1.0.0-1.noarch.rpm | b0e6042b46235c3acf9199acc7a19f53 | 8.0            | Liberty             |
+--------------------------------------------------+----------------------------------+----------------+---------------------+
